...
export default function PracticalInfo() {
  ...
  const [openIdx, setOpenIdx] = useState(null) // for mobile accordion
              ...
              ? 
                ...
                >
                  ...
                  >
                    ...
                    <span className="pi__acc-arrow" aria-hidden="true">›</span>
                  </button>
                  <div
                    id={`acc-body-${i}`}
                    className="pi__acc-bd"
                    role="region"
                  >
                    <p>{item.body}</p>
                  </div>
