...
export default function ContactForm() {
  ...
  const validate = () => {
    ...
    if (!form.message.trim()) e.message = "Tell us a bit about your plans";
    return e;
  };
      ...
      <section id="contact" aria-labelledby="cf-title">
        <div className="container">
          <div className="cf__success" role="alert" aria-live="polite">
            <span className="cf__success-icon" aria-hidden="true">
              ✅
            </span>
            <h3>Thanks!</h3>
            <p>
              We've received your request. We'll reach out with tips for your
              trip.
            </p>
            <button
  ...
  return (
    <section id="contact" aria-labelledby="cf-title">
      <div className="container">
        ...
        <div
          className="cf__form fade-in"
          role="form"
          aria-label="Travel consultation form"
        >
